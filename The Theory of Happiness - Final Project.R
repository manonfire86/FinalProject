### Title: A glimpse into Global Happiness
...
### Below is the mapping of the top 30 Countries Based on Happiness Rankings from 2015 to 2017. As you can there are some major shifts where countries lost there entire standing within the top 30 or gained position with the top 30, for instance the Czech Republic was not present in 2015 but made the top 30 in 2016 and 2017.
### The USA shifted between rank 15, 13, and 14 between 2015 and 2017.
...
### Given the macro level it is then safe to question what were the largest contributing factors for countries that experience the largest shifts in rankings. Taking the absoulte average changes in the data set and then mapping these rankings to their natural year over year changes, I parsed the top 10 countries that experienced the greatest shifts.
...
### Despite the higher economic ranking happiness is rankings as of 2016 are at 14th place.
